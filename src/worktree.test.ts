...
describe('project worktrees', () => {
  test('serializes create and remove for one canonical project root', async () => {
    const { repo } = initRepo()
  ...
  test('keeps different projects concurrent and releases the lock after errors', async () => {
